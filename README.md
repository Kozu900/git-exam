...
Le site affiche pour le moment une page vide.Une fonctionnalité seront développées en parallèle, depuis la branche `dev` déjà existante (voir schéma de l’état initial du dépôt).
